...
class TestOrderbook:
    ...
    @pytest.mark.asyncio
    @pytest.mark.parametrize("orderbook_case", ["TC_BOOK_002"], indirect=True)
    ...
    @allure.severity(allure.severity_level.NORMAL)
    @pytest.mark.asyncio
    @pytest.mark.parametrize("orderbook_case", ["TC_BOOK_003"], indirect=True)
    ...
    @allure.severity(allure.severity_level.NORMAL)
    @pytest.mark.asyncio
    @pytest.mark.parametrize("orderbook_case", ["TC_BOOK_004"], indirect=True)
    ...
    @allure.severity(allure.severity_level.NORMAL)
    @pytest.mark.asyncio
    @pytest.mark.parametrize("orderbook_case", ["TC_BOOK_005"], indirect=True)
    ...
    @allure.severity(allure.severity_level.NORMAL)
    @pytest.mark.asyncio
    @pytest.mark.parametrize("orderbook_case", ["TC_BOOK_006"], indirect=True)
